...
public class InvarTools {
    ...
    public static final SwordItem INVAR_SWORD = new SwordItem(INVAR_TOOL_MATERIAL, 6, -2.4F, new FabricItemSettings().group(ItemGroup.COMBAT));
    public static final PickaxeItem INVAR_PICKAXE = new PickaxeItem(INVAR_TOOL_MATERIAL, 1, -2.8F, new FabricItemSettings().group(ItemGroup.TOOLS));
    ...
    public static final ShovelItem INVAR_SHOVEL = new ShovelItem(INVAR_TOOL_MATERIAL, 1.5F, -3.0F, new FabricItemSettings().group(ItemGroup.TOOLS));
